...
<body>
        ...
        <div class="login-container">
            ...
            <form id="loginForm" method="POST" action="{{ route('login') }}">
                ...
                <div class="form-group">
                    ...
                    <a href="#" class="text-purple-600 hover:text-purple-800" onclick="event.preventDefault(); showPasswordResetForm();">¿Olvidaste tu contraseña?</a>
    ...
    <div class="overlay fixed inset-0 z-50 flex items-center justify-center hidden" id="errorModal">
        <div class="bg-white p-6 rounded-lg shadow-lg text-center">
            ...
            <p class="text-gray-600">No se pudo enviar el correo de recuperación. Por favor, inténtalo de nuevo más tarde.</p>
        </div>
    </div>
