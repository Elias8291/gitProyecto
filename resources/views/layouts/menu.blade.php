...
<li class="side-menus {{ Request::is('*') ? 'active' : '' }}">
  ...
  @can(['ver-estudiante', 'crear-estudiante', 'editar-estudiante', 'borrar-estudiante'])
    <li class="{{ Request::is('estudiantes*') ? 'active' : '' }}">
      <a class="nav-link d-flex align-items-center" href="/estudiantes">
        <i class="fas fa-user-graduate text-success mr-2"></i><span class="menu-text">Estudiantes</span>
      </a>
    </li>
  @endcan
  ...
  @can('ver-logs')
    <li class="{{ Request::is('logss') ? 'active' : '' }}">
      <a class="nav-link d-flex align-items-center  " href="/logss"><i class="fas fa-building text-info mr-2" style="color: #5642F5;"></i><span class="menu-text">Logs</span>
